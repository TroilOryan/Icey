...
try {
    ...
    $data = @{
        'icey.versionName' = $versionName
        'icey.versionCode' = $versionCode
        'icey.commitHash' = $commitHash
        'icey.buildTime' = $buildTime
    }

    $data | ConvertTo-Json -Compress | Out-File 'icey_release.json' -Encoding UTF8
